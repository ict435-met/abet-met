...
<p>NMSU MET (ABET Criterion 9)</p>

<p>An ability to select and apply the knowledge, techniques, skills, and modern tools of the discipline; to include:</p>
 
<p>9a Algebra, trigonometry, Boolean mathematics, calculus, statistics and probability, fundamental principles and concepts of science and engineering technology, good practice in problem solving, and methods of standard practice in the analysis and applied design of mechanical systems.
(also ABET 3a, 3b, and 3d)</p>
 
<p>9b Fundamental aspects of AC and DC circuits, electrical components, computer programming logic, instrumentation principles, experimental techniques, methods of standard practice in the testing and evaluation of mechanical systems, safety consciousness, critical thinking skills, and codes and standards.
(also ABET 3a, 3b, and 3c)</p>
 
<p>9c Basic knowledge of manufacturing processes, engineering materials and their selection, measuring tools, machine tools, quality systems and processes, process improvement methods, economic principles, cost analysis techniques, and project management, relevant to mechanical technology areas.
(also ABET 3a, 3b, and 3d)</p>
 
<p>9d Current software corresponding to good practice in the application of mechanical engineering technologies. Software application functions to include: word processing, spreadsheet calculations, graphing, presentation media, computer assisted drafting and manufacturing, manufacturing processes, statistics, data acquisition, project management, and the analysis and applied design of systems involving mechanisms, machines, or fluid and thermal processes.
(also ABET 3a)</p>
 
<p>And, with respect to validation that graduates have been prepared for careers in their discipline, or postgraduate academic study in the discipline or a related one:</p>

<p>9e Graduates will receive offers for employment positions, commensurate with the level of a Bachelor&#39;s degree in technology, or be accepted into a Master&#39;s degree program for which the degree constitutes a prerequisite.</p>
...
<p>In conjunction with the closely-related student outcomes, the above program educational objectives are intended to help ensure that graduates may better compete in a changing world.</p>
                        '),
	array("title" => "Outcomes",
	      "content" => '<strong>Graduates in the NMSU Mechanical Engineering Technology program will have:</strong>

<p>An appropriate mastery of the knowledge, techniques, skills and modern tools of Mechanical Engineering Technology, including the following ABET Criterion 3 :</p>
...
<p>3j. a knowledge of the impact of engineering technology solutions in a societal and global
...
<p>All student outcomes are listed and mapped under Criterion 3.</p>
                        ')
));
